...
cd /usr/local/src/lemp-20-04/etc/nginx/sites-available/ && wget https://raw.githubusercontent.com/roshanmaadhaiah/lampsetup/main/Apache-yaml/etc/nginx/sites-available/Cloudstack
...
cd /usr/local/src/lemp-20-04/ && wget wget https://raw.githubusercontent.com/stackbill/marketplace/main/lemp-20-04/lemp.yaml
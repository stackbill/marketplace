...
cd /usr/local/src/apachekafka-22-04/etc/systemd/system/ && wget https://raw.githubusercontent.com/stackbill/marketplace/main/etc/systemd/system/zookeeper.service

cd /usr/local/src/apachekafka-22-04/etc/systemd/system/ && wget https://raw.githubusercontent.com/stackbill/marketplace/main/etc/systemd/system/kafka.service

cd /usr/local/src/apachekafka-22-04/opt/kafka/config/ && wget https://raw.githubusercontent.com/stackbill/marketplace/main/opt/kafka/config/server.properties

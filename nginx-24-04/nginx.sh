...
cd /usr/local/src/nginx-24-04/opt/cloudstack/ && wget https://raw.githubusercontent.com/stackbill/marketplace/refs/heads/main/nginx-24-04/nginx-cleanup.sh

cd /usr/local/src/nginx-24-04/ && wget https://raw.githubusercontent.com/stackbill/marketplace/refs/heads/main/nginx-24-04/nginx-24-04.yaml
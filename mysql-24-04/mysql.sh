...
cd /usr/local/src/mysql-24-04/opt/cloudstack/ && wget -O /usr/local/src/mysql-24-04/opt/cloudstack/mysql-cleanup.sh https://github.com/kanagarajb0720/marketplace/blob/main/mysql-24-04/mysql-cleanup.sh
